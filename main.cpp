    ...
    if (engine.getState()) {
        ...
        while (true) {
            ...
            if (GetKeyState('S') & 0x8000) {
                ...
                std::printf("%3d",
                            speed);                                                                                      //wyswietlanie aktualnej predkosci, kasuje poprzednia wypisana predkosc i zastepuje je nowa predkoscia
                Sleep(100);
            }
//            if (GetKeyState('T') & 0x8000)
//            {
//                                                                                                       //klikniecie "t" + wcisniecie 1-6 lub "r" zmienia bieg
//                gearbox.setGearCount(gearcount);
//
//            }

            if (GetKeyState('M') &
                0x8000)                                                                                    //klikanie "m" konczy jazde
                break;
